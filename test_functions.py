...
ik_file = r"C:\Git\isbs2024\Data\Simulations\Athlete_22_torsion\sq_90\IK.mot"
bp.checkMuscleMomentArms(model_file_path=model, ik_file_path=ik_file, leg='r', threshold=0.005)
bp.checkMuscleMomentArms(model_file_path=model, ik_file_path=ik_file, leg='l', threshold=0.005)

model = r"C:\Git\isbs2024\Data\Scaled_models\Athlete_22_scaled.osim"
ik_file = r"C:\Git\isbs2024\Data\Simulations\Athlete_22\sq_70\IK.mot"
bp.checkMuscleMomentArms(model_file_path=model, ik_file_path=ik_file, leg='r', threshold=0.005)
bp.checkMuscleMomentArms(model_file_path=model, ik_file_path=ik_file, leg='l', threshold=0.005)

ik_file = r"C:\Git\isbs2024\Data\Simulations\Athlete_22\sq_90\IK.mot"
bp.checkMuscleMomentArms(model_file_path=model, ik_file_path=ik_file, leg='r', threshold=0.005)
bp.checkMuscleMomentArms(model_file_path=model, ik_file_path=ik_file, leg='l', threshold=0.005)
